...
namespace ZtbSoft.BLL
{
    ...
    public partial class SectionInfoBLL
    {
        /// <summary>
        /// 新增
        /// </summary>
        ...
        {
            SectionInfo sectionInfo = JsonHelper.JsonToObject<SectionInfo>(json);
            return new SectionInfoDAL().INSERT(sectionInfo);
        }
        ...
        {
            return new SectionInfoDAL().DeleteBySectionId(sectionId);
        }
        ...
        {
            SectionInfo sectionInfo = JsonHelper.JsonToObject<SectionInfo>(json);
            return new SectionInfoDAL().Update_V(sectionInfo);
        }
        /// <summary>
        /// 修改
        /// </summary>
        ...
        {
            return new SectionInfoDAL().GetBySectionId(sectionId);
        }
        /// <summary>
        /// 得到所有
        /// </summary>
        ...
        {
            DataTable dt = new SectionInfoDAL().GetAll("*", whe, "");
        ...
        {
            count = new SectionInfoDAL().GetCount(sel_whe);
            DataTable dt = new SectionInfoDAL().GetPage(sel_col, sel_whe, sel_ord, page_size, page);
            return JsonHelper.DataTableToArrayList(dt);
        }
