...
namespace ZtbSoft.BLL
{
    ...
    public partial class WorkFlowBLL
    {
        ...
        {
            WorkFlow workFlow = JsonHelper.JsonToObject<WorkFlow>(json);
            return new WorkFlowDAL().INSERT(workFlow);
        }
        ...
        {
            return new WorkFlowDAL().DeleteByCaseId(caseId);
        }
        ...
        {
            WorkFlow workFlow = JsonHelper.JsonToObject<WorkFlow>(json);
            return new WorkFlowDAL().Update_V(workFlow);
        }
        /// <summary>
        /// 修改
        /// </summary>
        ...
        {
            return new WorkFlowDAL().GetByCaseId(caseId);
        }
        /// <summary>
        /// 得到所有
        /// </summary>
        ...
        {
            DataTable dt = new WorkFlowDAL().GetAll("*", whe, "");
        ...
        {
            count = new WorkFlowDAL().GetCount(sel_whe);
            DataTable dt = new WorkFlowDAL().GetPage(sel_col, sel_whe, sel_ord, page_size, page);
            return JsonHelper.DataTableToArrayList(dt);
        }
