...
namespace ZtbSoft.BLL
{
    ...
    public partial class UnitBookBLL
    {
        /// <summary>
        /// 新增
        /// </summary>
        ...
        {
            UnitBook unitBook = JsonHelper.JsonToObject<UnitBook>(json);
            return new UnitBookDAL().INSERT(unitBook);
        }
        ...
        {
            return new UnitBookDAL().DeleteByUnitBookId(unitBookId);
        }
        ...
        {
            UnitBook unitBook = JsonHelper.JsonToObject<UnitBook>(json);
            return new UnitBookDAL().Update_V(unitBook);
        }
        /// <summary>
        /// 修改
        /// </summary>
        ...
        {
            return new UnitBookDAL().GetByUnitBookId(unitBookId);
        }
        /// <summary>
        /// 得到所有
        /// </summary>
        ...
        {
            DataTable dt = new UnitBookDAL().GetAll("*", whe, "");
        ...
        {
            count = new UnitBookDAL().GetCount(sel_whe);
            DataTable dt = new UnitBookDAL().GetPage(sel_col, sel_whe, sel_ord, page_size, page);
            return JsonHelper.DataTableToArrayList(dt);
        }
