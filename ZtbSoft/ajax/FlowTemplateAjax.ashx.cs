...
namespace ZtbSoft.Web.Ajax
{
    ...
    /// FlowTemplate 模版管理
    /// </summary>
    public class FlowTemplateAjax : IHttpHandler,IRequiresSessionState
    {
		
        private DataTable dtPower = null;   //当前用户权限
        private string powerCode = enum_PowerObjectCode.FlowTemplate.ToString();
        ...
        public void GetList(HttpContext context)
        {
            ...
            result["data"] = new FlowTemplateBLL().GetPage(sel_col, sel_whe, ord, pageSize, pageIndex, out count);
            result["total"] = count;
