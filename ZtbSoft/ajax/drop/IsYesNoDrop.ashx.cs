...
namespace ZtbSoft.WEB.ajax.drop
{
    ...
    /// IsYesNo 的摘要说明
    /// </summary>
    public class IsYesNoDrop : IHttpHandler,IRequiresSessionState
    {
        ...
        public void GetList(HttpContext context)
        {
            ...
            ArrayList data = new ZtbSoft.Components.clsEnmu().GetEnumObj(typeof(ZtbSoft.Components.enum_IsYesNo));
