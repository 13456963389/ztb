...
namespace ZtbSoft.WEB.ajax.drop
{
    ...
    /// UnitInfo 的摘要说明
    /// </summary>
    public class UnitInfoDrop : IHttpHandler, IRequiresSessionState
    {
        ...
        public void GetList(HttpContext context)
        {
            ...
            ArrayList data = new UnitInfoBLL().GetAll("");
            String json = JsonHelper.Encode(data);
            context.Response.ContentType = "text/plain";
            context.Response.Write(json);
        }

        public void GetListByUnitType(HttpContext context)
        {
            string unitType = context.Request["unType"];
            ArrayList data = new UnitInfoBLL().GetAll("UnitTypeId=" + unitType);
            String json = JsonHelper.Encode(data);
            context.Response.ContentType = "text/plain";
            context.Response.Write(json);
        }
